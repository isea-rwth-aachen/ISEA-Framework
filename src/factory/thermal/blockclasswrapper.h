...
class BlockClassWrapper< T, thermal::RectangularBlock > : public BlockClassWrapperBase< T >
{
    ...
    CreateInstance( const xmlparser::XmlParameter *param, const ArgumentTypeThermalBlock< T > *arg = 0 )
    {
        ...
        if ( material->GetMaterialType() != thermal::Material< T >::CARTESIAN &&
            ...
            ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "MaterialNonCartesianOrIsotropic", param->GetElementName(),
        ...
        if ( param->HasElementDirectChild( "ElectricalDiscretization" ) && !arg->mThermalStates.empty() )
        {
            ...
            if ( discParam->HasElementAttribute( "phi" ) || discParam->HasElementAttribute( "rho" ) )
                ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "InElectricalDiscretizationInRectBlockXyZAllowed", param->GetElementName(),
                                                     "RectangularBlock", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                     emplacementPoint.GetZ(), param->GetLineNumber() );
        }
...
class BlockClassWrapper< T, thermal::QuadraticCellBlock > : public BlockClassWrapperBase< T >
{
    ...
    CreateInstance( const xmlparser::XmlParameter *param, const ArgumentTypeThermalBlock< T > *arg = 0 )
    {
        ...
        if ( cellMaterial->GetMaterialType() != thermal::Material< T >::CYLINDRIC &&
            ...
            ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "CellMaterialNonCylindricOrIsotropic", param->GetElementName(),
        ...
        if ( fillMaterial->GetMaterialType() != thermal::Material< T >::CYLINDRIC &&
            ...
            ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "FillMaterialNonCylindricOrIsotropic", param->GetElementName(),
                                                 "QuadraticCellBlock", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                 emplacementPoint.GetZ(), param->GetLineNumber() );
        ...
        if ( param->HasElementDirectChild( "ElectricalDiscretization" ) && !arg->mThermalStates.empty() )
        {
            ...
            if ( discParam->HasElementAttribute( "x" ) || discParam->HasElementAttribute( "y" ) ||
                ...
                ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "InElectricalDiscretizationInQuadrCellBlockPhiOrZAllowed", param->GetElementName(),
                                                     "QuadraticCellBlock", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                     emplacementPoint.GetZ(), param->GetLineNumber() );
        }
...
class BlockClassWrapper< T, thermal::Supercap > : public BlockClassWrapperBase< T >
{
    ...
    CreateInstance( const xmlparser::XmlParameter *param, const ArgumentTypeThermalBlock< T > *arg = 0 )
    {
        ...
        if ( innerCellMaterial->GetMaterialType() != thermal::Material< T >::CYLINDRIC &&
            ...
            ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "InnerCellMaterialNonCylindricOrIsotropic", param->GetElementName(),
        ...
        if ( outerCellMaterial->GetMaterialType() != thermal::Material< T >::CYLINDRIC &&
            ...
            ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "OuterCellMaterialNonCylindricOrIsotropic", param->GetElementName(),
                                                 "Supercap", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                 emplacementPoint.GetZ(), param->GetLineNumber() );
        ...
        if ( param->HasElementDirectChild( "ElectricalDiscretization" ) && !arg->mThermalStates.empty() )
        {
            ...
            if ( discParam->HasElementAttribute( "x" ) || discParam->HasElementAttribute( "y" ) ||
                ...
                ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "InElectricalDiscretizationInSupercapPhiOrZAllowed", param->GetElementName(),
                                                     "Supercap", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                     emplacementPoint.GetZ(), param->GetLineNumber() );
        }
    ...
    CreateInstance( const xmlparser::XmlParameter *param, const ArgumentTypeThermalBlock< T > *arg = 0 )
    {
        ...
        if ( param->HasElementDirectChild( "ElectricalDiscretization" ) && !arg->mThermalStates.empty() )
        {
            ...
            if ( discParam->HasElementAttribute( "x" ) || discParam->HasElementAttribute( "y" ) ||
                ...
                ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "InElectricalDiscretizationInHexCellBlockPhiOrZAllowed", param->GetElementName(),
                                                     "HexagonalCellBlock", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                     emplacementPoint.GetZ(), param->GetLineNumber() );
        }
...
class BlockClassWrapper< T, thermal::TriangularPrismBlock > : public BlockClassWrapperBase< T >
{
    ...
    CreateInstance( const xmlparser::XmlParameter *param, const ArgumentTypeThermalBlock< T > *arg = 0 )
    {
        ...
        if ( material->GetMaterialType() != thermal::Material< T >::CARTESIAN &&
            ...
            ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "MaterialNonCartesianOrIsotropic", param->GetElementName(),
                                                 "TriangularPrismBlock", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                 emplacementPoint.GetZ(), param->GetLineNumber() );
        ...
        if ( verticesError )
            ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "VerticesThreeTimesTwoElements", param->GetElementName(),
                                                 "TriangularPrismBlock", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                 emplacementPoint.GetZ(), param->GetLineNumber() );
        ...
        if ( param->HasElementDirectChild( "ElectricalDiscretization" ) && !arg->mThermalStates.empty() )
        {
            ...
            if ( discParam->HasElementAttribute( "x" ) || discParam->HasElementAttribute( "y" ) ||
                ...
                ErrorFunction< std::runtime_error >( __FUNCTION__, __LINE__, __FILE__, "InElectricalDiscretizationInTriangPrismBlockZAllowed", param->GetElementName(),
                                                     "TriangularPrismBlock", emplacementPoint.GetX(), emplacementPoint.GetY(),
                                                     emplacementPoint.GetZ(), param->GetLineNumber() );
        }
