...
///ThermalBlock is an interface class, whose subclasses contain information to build different parts of the thermal part of the model
template<typename T = double>
class ThermalBlock
{
public:
    /**
     * @param[in] thermalStates Thermal States (connections to electrical model) that have to be distributed inside block
     ...
     * @param[out] conductivityMatrix List of thermal conductivity between thermal elements with indices: From index as vector position to index in IndexedValue
