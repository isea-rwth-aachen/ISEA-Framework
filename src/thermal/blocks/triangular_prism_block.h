...
void TriangularPrismBlock< T >::GetSurfaceAreas( vector< IndexedArea< T > > &surfaceAreas ) const
{
    ...
    surfaceAreas.push_back(
     IndexedArea< T >( 0, Area< T >( vertices, Plane< T >( mEmplacementPoint, xAxis, yAxis ), mDimZ * 0.5,
                                     mMaterial->GetConductivity( 2 ), mMaterial->GetEmissivity(), BOTTOM ) ) );
    ...
    surfaceAreas.push_back(
     IndexedArea< T >( mNZ - 1, Area< T >( vertices, Plane< T >( Cartesian< T >( 0.0, 0.0, mNZ * mDimZ ) + mEmplacementPoint, xAxis, yAxis ),
                                           0.5 * mDimZ, mMaterial->GetConductivity( 2 ), mMaterial->GetEmissivity(), TOP ) ) );
    ...
    for ( size_t k = 0; k < mNZ; ++k )
    {
        surfaceAreas.push_back( IndexedArea< T >(
         k, Area< T >( vertices,
                       ...
                       CalculateConductivityNormalToSurfaceArea( mVertex1, mVertex2 ), mMaterial->GetEmissivity(), SIDE ) ) );
        ...
        surfaceAreas.push_back( IndexedArea< T >(
         k, Area< T >( vertices2,
                       ...
                       CalculateConductivityNormalToSurfaceArea( mVertex2, mVertex3 ), mMaterial->GetEmissivity(), SIDE ) ) );
        ...
        surfaceAreas.push_back( IndexedArea< T >(
         k, Area< T >( vertices3,
                       ...
                       CalculateConductivityNormalToSurfaceArea( mVertex3, mVertex1 ), mMaterial->GetEmissivity(), SIDE ) ) );
    }
}
