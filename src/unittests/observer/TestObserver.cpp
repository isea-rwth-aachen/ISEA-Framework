...
void TestObserver::testObserverOperationsSingleCell()
{
    ...
    cells.push_back( cellelem );

    observer::TwoPortObserver< myMatrixType > k( cells );
...
void TestObserver::testFilters()
{
    ...
    boost::shared_ptr< electrical::OhmicResistance< myMatrixType > > r( new electrical::OhmicResistance< myMatrixType >( rObject ) );
    boost::shared_ptr< electrical::VoltageSource< myMatrixType > > ocv( new electrical::VoltageSource< myMatrixType >( ocvObject ) );
    boost::shared_ptr< electrical::Cellelement< myMatrixType > > cell(
     new electrical::Cellelement< myMatrixType >( tempState, socState ) );
    cell->AddChild( r );
    cell->AddChild( ocv );

    std::vector< boost::shared_ptr< electrical::TwoPort< myMatrixType > > > emptyVector;
    std::vector< boost::shared_ptr< electrical::TwoPort< myMatrixType > > > twoPorts;
    twoPorts.push_back( cell );

    testFilterCreation( emptyVector, 0 );
    testFilterCreation( twoPorts, 0 );
    testFilterCreation( twoPorts, boost::static_pointer_cast< electrical::TwoPort< myMatrixType > >( cell ) );
}
                                       ...
                                       const boost::shared_ptr< electrical::TwoPort< myMatrixType > > &rootPort = nullptr )
{
    ...
    tpObserver.AddFilter( boost::shared_ptr< observer::StdoutFilterTwoPort< myMatrixType > >(
     new observer::StdoutFilterTwoPort< myMatrixType >( nullStream ) ) );
    tpObserver.AddFilter( boost::shared_ptr< observer::MatlabFilterTwoPort< myMatrixType > >(
     new observer::MatlabFilterTwoPort< myMatrixType >( "filtertest.mat" ) ) );
    tpObserver.AddFilter( boost::shared_ptr< observer::CsvFilterTwoPort< myMatrixType > >(
     new observer::CsvFilterTwoPort< myMatrixType >( "filtertest.csv" ) ) );
