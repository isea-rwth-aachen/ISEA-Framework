...
void TestCoolingFunctions::TestConvectionByFormula()
{
    ...
    const double pr_Air = 0.7075;              // VDI D2.2 Tablle 16 25°C 1 bar
    const double lambda_Air = 26.25 / 1000;    // VDI D2.2 Tablle 12 25°C 1 bar
    const double ny_Air = 0.00001579;          // VDI D2.2 Tabelle 14 157.9 * 10^-7 m²/s  25°C 1 bar
    const double g = 9.81;
